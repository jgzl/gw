...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '路由配置表' ROW_FORMAT = Dynamic;
...
INSERT INTO `gateway_route_conf` VALUES (2, '网关管理', 'gateway-admin-bootstrap', '[{\"args\": {\"_genkey_0\": \"/gateway-admin/**\"}, \"name\": \"Path\"}]', '[]', 'lb://gateway-admin-bootstrap', 0, '{\"version\": \"1\"}', '2021-12-27 10:43:25', '2022-01-06 10:40:46', '0');
...
CREATE TABLE `sys_menu`  (
  ...
  `keep_alive` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '是否缓存',
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1000, '系统管理', NULL, '/system', -1, 'SettingIcon', 0, '0', '0', '2018-09-28 08:29:53', '2021-12-27 15:13:30', '0');
INSERT INTO `sys_menu` VALUES (1100, '用户管理', NULL, '/system/user', 1000, 'MenuIcon', 1, '0', '0', '2017-11-02 22:24:37', '2021-12-28 20:15:53', '0');
INSERT INTO `sys_menu` VALUES (1101, '用户新增', 'sys_user_add', NULL, 1100, NULL, 1, '0', '1', '2017-11-08 09:52:09', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1102, '用户修改', 'sys_user_edit', NULL, 1100, NULL, 1, '0', '1', '2017-11-08 09:52:48', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1103, '用户删除', 'sys_user_del', NULL, 1100, NULL, 1, '0', '1', '2017-11-08 09:54:01', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1104, '导入导出', 'sys_user_export', NULL, 1100, NULL, 1, '0', '1', '2017-11-08 09:54:01', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1200, '菜单管理', NULL, '/system/menu', 1000, 'MenuIcon', 2, '0', '0', '2017-11-08 09:57:27', '2021-12-28 20:14:22', '0');
INSERT INTO `sys_menu` VALUES (1201, '菜单新增', 'sys_menu_add', NULL, 1200, NULL, 1, '0', '1', '2017-11-08 10:15:53', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1202, '菜单修改', 'sys_menu_edit', NULL, 1200, NULL, 1, '0', '1', '2017-11-08 10:16:23', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1203, '菜单删除', 'sys_menu_del', NULL, 1200, NULL, 1, '0', '1', '2017-11-08 10:16:43', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1300, '角色管理', NULL, '/system/role', 1000, 'MenuIcon', 3, '0', '0', '2017-11-08 10:13:37', '2021-12-28 20:14:19', '0');
INSERT INTO `sys_menu` VALUES (1301, '角色新增', 'sys_role_add', NULL, 1300, NULL, 1, '0', '1', '2017-11-08 10:14:18', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1302, '角色修改', 'sys_role_edit', NULL, 1300, NULL, 1, '0', '1', '2017-11-08 10:14:41', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1303, '角色删除', 'sys_role_del', NULL, 1300, NULL, 1, '0', '1', '2017-11-08 10:14:59', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1304, '分配权限', 'sys_role_perm', NULL, 1300, NULL, 1, '0', '1', '2018-04-20 07:22:55', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1400, '部门管理', NULL, '/system/department', 1000, 'MenuIcon', 4, '0', '0', '2018-01-20 13:17:19', '2021-12-28 20:14:16', '0');
INSERT INTO `sys_menu` VALUES (1401, '部门新增', 'sys_dept_add', NULL, 1400, NULL, 1, '0', '1', '2018-01-20 14:56:16', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1402, '部门修改', 'sys_dept_edit', NULL, 1400, NULL, 1, '0', '1', '2018-01-20 14:56:59', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (1403, '部门删除', 'sys_dept_del', NULL, 1400, NULL, 1, '0', '1', '2018-01-20 14:57:28', '2021-05-25 03:12:55', '0');
INSERT INTO `sys_menu` VALUES (2000, '网关管理', NULL, '/gateway', -1, 'MapLocationIcon', 1, '0', '0', '2018-09-04 05:58:41', '2021-12-31 16:17:42', '0');
INSERT INTO `sys_menu` VALUES (2100, '网关日志', NULL, '/gateway/log', 2000, 'MenuIcon', 1, '0', '0', '2018-09-04 05:58:41', '2021-12-28 20:14:25', '0');
INSERT INTO `sys_menu` VALUES (2200, '动态路由', NULL, '/gateway/route', 2000, 'MenuIcon', 2, '0', '0', '2018-09-04 05:58:41', '2021-12-28 20:14:28', '0');
